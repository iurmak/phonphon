...
app.config['MAIL_USERNAME'] = 'phonetics.phonology.hse@gmail.com'
app.config['MAIL_DEFAULT_SENDER'] = 'phonetics.phonology.hse@gmail.com'
app.config['MAIL_PASSWORD'] = 'nrwzmbkqkkmgyajd'
...
import q_a.login, q_a.questions, q_a.question, \
    ...
    q_a.edit_post, q_a.about, q_a.materials
